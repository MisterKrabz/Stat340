---
title: "STAT 340 Discussion 0: R review"
...
```{r}
interval <- seq(from = 0, to = 1, by = 1/15)
...
1. Given an `n` and `k`, compute the binomial coefficient,
...
sqrt((sum((vector-mean(vector))^2))/10)
```
...
Then, write a function `is_even` (remember that thing about good function
