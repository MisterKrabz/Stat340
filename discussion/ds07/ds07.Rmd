...
pp <- pp + geom_histogram(aes(y = ..density..), bins = 30, fill = "blue", alpha = 0.5) 

pp <- pp + stat_function(fun = dnorm, args = list(mean = 0, sd = 1), color = "red", size = 1) 

pp <- pp + facet_wrap(~n)
pp <- pp + labs(title = "CLT with Poisson(λ=4) Distribution",
