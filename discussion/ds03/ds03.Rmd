...
coordinates <- matrix(x, nrow = N, ncol = 6, byrow = TRUE)
...
```{r}
distance <- mean(sqrt((coordinates[,4] - coordinates[,1])^2 + 
           (coordinates[,5] - coordinates[,2])^2 + 
...
```{r}
(distance - 0.661705)/0.661705 * 100
```
