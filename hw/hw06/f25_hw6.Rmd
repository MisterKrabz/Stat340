...
hist(x_bar_estimates,
     main = "Sampling Distribution of X-bar for λ",
...
hist(s_squared_estimates,
     main = "Sampling Distribution of S-squared for λ",
...
```{r}
cov_xbar_s2 <- cov(x_bar_estimates, s_squared_estimates)
var_xbar <- var(x_bar_estimates)
var_s2 <- var(s_squared_estimates)

cov_xbar_s2
var_xbar
var_s2

cor(x_bar_estimates, s_squared_estimates)
```
> the best estimator is still xbar because the variance for S^2 is higher than xbar
...
> the best one to estimate the population mean is the windsorized mean because it ahas low bias and variance similar to the sample mean and is more immune to skewness, making it the best estimate of thhe population mean. 
