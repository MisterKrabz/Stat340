...
> p = 0.5086 (which is less than alpha = 0.05). We fail to reject the null hypothesis. There is no statistically significant evidence that he gets more sales with consulting as compared to without consulting. 
